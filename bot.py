...
def build_samuil_system_prompt(include_maxim_context: bool) -> str:
    ...
    maxim_ctx = (
        ...
        "себе юную девушку, которая им почему-то не интересуется. "
...
async def generate_sarcastic_reply_for_maxim(now: datetime, user_text: str) -> Tuple[Optional[str], Optional[str]]:
    ...
    user_prompt = (
        ...
        "Можно аккуратно подколоть его одиночество, поиски молодой девушки или чувство собственной гениальности, "
        "но без жестокости."
    )
...
async def good_night_job(context: ContextTypes.DEFAULT_TYPE):
    ...
    user_prompt = (
        ...
        "от имени Самуила. Можно мягко подколоть его одинокие вечера, поиски молодой девушки "
